<?php $pageTitle = "Скачать видео из Facebook"; include 'includes/header.php'; ?>

<div class="row w-100 justify-content-center">
    <div class="col-md-8 col-lg-6">
        <div class="glass-card p-5">
            <div class="text-center mb-4">
                <h1 class="fw-bold mb-2"><span class="gradient-text">Facebook</span></h1>
                <p style="color: var(--text-secondary);">Скачивайте любые видео из Facebook в максимально возможном качестве.</p>
            </div>
            ...
            <div id="qualitySelection" class="mt-4 d-none">
                ...
                <div id="qualityOptions" class="d-grid gap-2"></div>
            </div>
