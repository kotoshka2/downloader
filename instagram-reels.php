<?php $pageTitle = "Скачать Instagram Reels"; include 'includes/header.php'; ?>

<div class="row w-100 justify-content-center">
    <div class="col-md-8 col-lg-6">
        <div class="glass-card p-5">
            <div class="text-center mb-4">
                <h1 class="fw-bold mb-2"><span class="gradient-text">Instagram Reels</span></h1>
                <p style="color: var(--text-secondary);">Скачивайте Reels из Instagram в лучшем качестве быстро и без водяных знаков.</p>
            </div>
            ...
            <form id="downloadForm">
                <div class="mb-3 input-group input-group-lg">
                    ...
                    <input type="url" class="form-control border-start-0 ps-0" id="videoUrl" placeholder="Вставьте ссылку на Reels..." required>
                </div>
